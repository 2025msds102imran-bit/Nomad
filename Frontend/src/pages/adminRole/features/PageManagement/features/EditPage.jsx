...
export default function EditPage({ page, onBack, onUpdate }) {
  ...
  const canUpdate = useMemo(() => pageName.trim() && status.trim(), [pageName, status]);
  ...
  return (
    <div data-layer="Main Content" className="MainContent w-full flex-1 flex flex-col justify-start items-start overflow-hidden">
      <div data-layer="Frame 1597884179" className="Frame1597884179 w-full flex flex-col justify-start items-start gap-5">
        <button
          type="button"
          onClick={handleBack}
          data-layer="Button"
        ...
        >
          ...
          <span className="text-center text-gray-500 text-base font-medium font-['Inter'] leading-6">
        ...
        >
          <div data-layer="Heading 1" className="Heading1 w-full">
            <div data-layer="Edit Page" className="EditPage text-slate-900 text-2xl font-semibold font-['Inter'] leading-9">
              Edit Page
            </div>
          </div>
          ...
          <div data-layer="Container" className="Container w-full flex flex-col justify-start items-start gap-6">
            <div data-layer="Container" className="Container w-full grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div data-layer="Container" className="Container inline-flex flex-col justify-start items-start gap-2">
                ...
                <div ref={statusRef} className="relative w-full">
                  ...
                  {isStatusOpen && (
                    <div className="absolute top-full left-0 z-20 mt-2 w-56 max-w-full max-h-72 overflow-auto p-3 bg-white rounded-[20px] shadow-lg outline outline-1 outline-gray-100 inline-flex justify-start items-center gap-2.5">
                      <div className="flex-1 inline-flex flex-col justify-start items-start gap-3.5">
                        <button
                          ...
                          className="w-full text-left text-neutral-950 text-base font-normal font-['Inter'] hover:bg-gray-50 rounded-lg px-2 py-1"
                        >
                          Select status
                        </button>
            ...
            <div data-layer="Container" className="Container w-full inline-flex flex-wrap justify-start items-center gap-4">
              <button
                type="submit"
                disabled={!canUpdate}
                className="w-32 h-11 bg-cyan-900 rounded-[10px] inline-flex items-center justify-center text-white text-base font-medium font-['Inter'] leading-6 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-cyan-800"
              >
                Update Page
              </button>
              <button
                type="button"
                onClick={handleBack}
                className="w-24 h-11 rounded-[10px] outline outline-[1.30px] outline-offset-[-1.30px] outline-gray-200 inline-flex justify-center items-center gap-2.5 text-gray-600 text-base font-medium font-['Inter'] leading-6 hover:bg-gray-50"
              >
                Cancel
              </button>
            </div>
