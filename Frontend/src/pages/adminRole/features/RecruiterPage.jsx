...
const RecruiterPage = () => {
  ...
  const enrichedRecruiters = useMemo(
    () =>
      recruiters.map((r) => ({
        ...r,
  ...
  const filtered = useMemo(() => {
    if (!searchQuery.trim()) return enrichedRecruiters;
    const q = searchQuery.toLowerCase();
    return enrichedRecruiters.filter(
      (r) =>
        r.name.toLowerCase().includes(q) ||
        r.email.toLowerCase().includes(q) ||
        r.speciality.toLowerCase().includes(q)
    );
  }, [searchQuery, enrichedRecruiters]);
                            ...
                            >
                              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clipPath={`url(#clip0_view_${row.id})`}>
                                  ...
                                  <path d="M7.99718 9.9957C9.10127 9.9957 9.99631 9.10066 9.99631 7.99657C9.99631 6.89248 9.10127 5.99744 7.99718 5.99744C6.89309 5.99744 5.99805 6.89248 5.99805 7.99657C5.99805 9.10066 6.89309 9.9957 7.99718 9.9957Z" stroke="white" strokeWidth="1.33275" strokeLinecap="round" strokeLinejoin="round"/>
                                </g>
                            ...
                            <div className="Frame32 self-stretch px-3 flex flex-col justify-start items-start gap-3">
                              ...
                              >
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  ...
                                  <path d="M5.71289 5.71436L10.2843 10.2858M10.2843 5.71436L5.71289 10.2858" stroke="#4A5565" strokeWidth="0.9" strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
